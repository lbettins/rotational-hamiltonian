...
int main(int argc, char** argv) {
     ...
     */
    if (argc != 3) {
        throw std::runtime_error("Enter systemName as it appears in data directory, Lmax");
    }
    ...
    do {
        ...
        if (dense) {
            ...
            SpMat<double> H = getSparseHam(lmax, Ivec[0], Ivec[1], Ivec[2]);
            Q = getSparseQ(300, H, sigma);
            /****************************************/
        }
...
double getPartitionFunction(double T, Mat<double>& H, int sym) {
